...
public class Tutorial01 {
	...
	public static void main(String[] args) throws IOException {
		...
		String outputUrl = "rtmp://testserver2/mylive/8888";

		AVFormatContext pFormatCtx = new AVFormatContext(null), pOutFormatCtx = new AVFormatContext(null);
		int i, videoStream;
		...
		avformat_alloc_output_context2(pOutFormatCtx, null, "flv", outputUrl);
		avio_open(pOutFormatCtx.pb(), outputUrl, AVIO_FLAG_WRITE);
		avformat_write_header(pOutFormatCtx, (AVDictionary) null);
		...
		// of AVPicture
		avpicture_fill(new AVPicture(pFrameRGB), buffer, AV_PIX_FMT_RGB24, pCodecCtx.width(), pCodecCtx.height());
